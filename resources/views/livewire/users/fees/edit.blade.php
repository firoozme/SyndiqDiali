<div>
    <!-- Breadcrumb -->
    {{ Breadcrumbs::render('fee.edit', $fee->syndicate, $fee) }}
    <!-- Breadcrumb -->
    <div class="card">
        ...
        <div class="card-body">
            <form wire:submit.prevent="update">
                <div class="form-group">
                    <div class="row p-3 mb-3 border-b text-center">
                        <div class="col-md-4 offset-md-4">
                            @if ($this->fee->paymentDocumentType()=='image')
                                <img src="{{ asset('upload/fees/'.$this->fee->payment_document ) }}" class="img-fluid img-thumbnail">
                            @elseif($this->fee->paymentDocumentType()=='pdf')
                                <a href="{{ asset('upload/fees/'.$this->fee->payment_document ) }}"><img src="{{ asset('images/pdf.png') }}" class="img-fluid img-thumbnail"></a>
                            @endif
                            @if ($document)
                            @php
                                try{
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <label for="syndicate_item" class="block">Syndicate <span class="text-danger">*</span></label>
                ...
                <a href="{{ route('user.syndicate.fees',['syndicate_id'=>$fee->syndicate_id]) }}" class="btn btn-danger"> Cancel</a>
            </form>
        </div>
    </div>
